     ...
     this.state = {
          ...
          return(
               <div className="fullDate">
                   ...
                   <img  src="https://lolstatic-a.akamaihd.net/frontpage/apps/prod/signup/en_US/89d3e008377d368fc97c63ff92fbee3ee5ae599c/assets/en_US/assets/divider.png"/>
                   </div>                 <div className="Clock-hours">
                         {this.leading0(this.state.hours)} heures
                    </div><div className="vr"></div><div className="Clock-minutes">
